...
public class UserPanel extends JFrame {
    ...
    private void initComponents() {
        ...
        //---- label1 ----
        label1.setIcon(new ImageIcon(getClass().getResource("/labelEmailIcon.png")));
        label1.setHorizontalAlignment(SwingConstants.CENTER);

        //---- label2 ----
        label2.setIcon(new ImageIcon(getClass().getResource("/labelPasswordIcon.png")));
        ...
        btnLogin.setIcon(new ImageIcon(getClass().getResource("/btnLoginIcon.png")));
        ...
        btnForgetPassword.setIcon(null);
        ...
        //---- label3 ----
        label3.setIcon(new ImageIcon(getClass().getResource("/shoppingIcon.png")));
