...
public class UserForgetPassword extends JFrame {
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //---- label4 ----
            label4.setIcon(new ImageIcon(getClass().getResource("/forgetV2.png")));
            ...
            panel1Layout.setHorizontalGroup(
                panel1Layout.createParallelGroup()
                    .addGroup(GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
                        ...
                        .addComponent(label4, GroupLayout.PREFERRED_SIZE, 158, GroupLayout.PREFERRED_SIZE)
                        .addGap(116, 116, 116))
            );
            panel1Layout.setVerticalGroup(
                panel1Layout.createParallelGroup()
                    .addGroup(GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(label4, GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE)
                        .addContainerGap())
            );
        }
